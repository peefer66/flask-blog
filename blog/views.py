...
def index(page=1):
    ...
    post = Post.query.filter_by(live=True).order_by(Post.publish_date.desc()).paginate(page, POST_PER_PAGE, False)
...
def admin(page=1):
    if session.get('is_author'):
        post = Post.query.order_by(Post.publish_date.desc()).paginate(page, POST_PER_PAGE, False)
